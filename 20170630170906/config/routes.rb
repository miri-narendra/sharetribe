Kassi::Application.routes.draw do
  ...
  scope "(/:locale)", :constraints => { :locale => locale_matcher } do
    ...
    get "/listings/:listing_id/post_pay_book" => "post_pay_transactions#book", :as => :post_pay_book
    post "/listings/:listing_id/post_pay_booked" => "post_pay_transactions#booked", :as => :post_pay_booked
    get "/listings/:listing_id/post_pay_inquire" => "post_pay_transactions#book", :as => :post_pay_inquire, :submit_type => PostPayTransactionsController::INQUIRY
    post "/listings/:listing_id/post_pay_inquired" => "post_pay_transactions#inquired", :as => :post_pay_inquired
    ...
    #TODO VP check that stripe can be created and destroyed
    get '/:person_id/settings/payments/stripe/new' => 'stripe_accounts#new', :as => :new_stripe_settings_payment
    get '/:person_id/settings/payments/stripe/show' => 'stripe_accounts#show', :as => :show_stripe_settings_payment
    get '/settings/payments/stripe/create' => 'stripe_accounts#create', :as => :create_stripe_settings_payment
    patch '/:person_id/settings/payments/stripe/destroy' => 'stripe_accounts#destroy', :as => :destroy_stripe_settings_payment
    ...
    get  '/community_memberships/check_phone_number_validity'           => 'community_memberships#check_phone_number_validity'
      ...
      resources :communities do
        ...
        resources :community_memberships do
          ...
          collection do
            ...
            post :promote_to_allow_inquiry
            post :posting_allowed
            post :set_commission_percent
          end
        end
    ...
    devise_scope :person do
      get '/gossrv/about', to: "people#about_gossrv", as: :about_gossrv
      ...
      resources :people, except: [:show] do
        collection do
          ...
          get :check_phone_number_validity
      ...
      resources :people, except: [:show], :path => "" do
        ...
        # Highjack transaction post-pay process, prepare a form to create a
        # new post pay transaction that will be already accepted
        ...
        resources :messages, :controller => :conversations do
          ...
          member do
            ...
            get :full_refund, to: 'refund_conversations#full_refund'
            get :partial_refund, to: 'refund_conversations#partial_refund'
            get :refund_and_cancel, to: 'refund_conversations#refund_and_cancel'
            put :refund, to: 'refund_conversations#refund'
          end
          resources :messages
