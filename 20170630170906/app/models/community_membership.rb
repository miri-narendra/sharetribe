...
#  commission_percent  :integer          default(100)
#  is_owner            :boolean
#  allow_inquiry       :boolean          default(FALSE)
#
# Indexes
#
...
class CommunityMembership < ActiveRecord::Base
  ...
  attr_protected :admin, :commission_percent
  ...
  # This approach is used to avoid commission percent to be set by mass assignments
  def set_commission_percent(percent)
    update_attribute(:commission_percent, percent)
  end
end
