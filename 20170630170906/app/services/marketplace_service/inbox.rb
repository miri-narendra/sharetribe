  ...
  module Inbox
    ...
    module QueryHelper
      ...
      transaction_spec = [
        ...
        [:booking_start_on, :date, :optional],
        [:booking_end_on, :date, :optional],
      ...
      def extend_transaction(transaction)
        ...
        payment_total =
          ...
          when :checkout, :braintree, :stripe
        ...
        payment_schedule = TransactionService::PaymentSchedule.get(community_id: transaction[:community_id], transaction_id: transaction[:transaction_id])
      ...
      @construct_sql = ->(params) {
        "
          SELECT
            ...
            bookings.start_on                                 AS booking_start_on,
            bookings.end_on                                   AS booking_end_on,
          ...
          LEFT JOIN transactions      ON transactions.conversation_id = conversations.id
          LEFT JOIN listings          ON transactions.listing_id = listings.id
          LEFT JOIN bookings          ON bookings.transaction_id = transactions.id
